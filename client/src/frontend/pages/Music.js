    ...
    return (
        <div>
            ...
            <div className="grid place-items-center py-5">
                <h1 className="text-5xl font-semibold text-white">Music NFT Gallery</h1>
                                            ...
                                            <div className="ml-[25rem] border-0 rounded-lg shadow-lg relative flex flex-col w-128 bg-gray-800 outline-none focus:outline-none ">
                                                <div className="flex items-start justify-between p-5 border-solid rounded-t">
                                                    ...
                                                    <button className="absolute right-6" onClick={() => setShowNavbar(false)} aria-hidden="false" aria-label="button">
                                                        <HiX className="h-7 w-7 text-white" aria-hidden="false" />
                                                    </button>
                                                ...
                                                <div className="grid place-items-center text-xl py-2 gap-2 w-full mb-4">
                                                    ...
                                                    <div className='py-2'>
                                                        <input className='w-96 p-2 active:border-none checked:border-none rounded-md text-xl' placeholder='ETH' value="0.11" />
                                                    </div>

                                                    <div className='py-2'>
                                                        <input className='w-96 p-2 active:border-none checked:border-none rounded-md text-xl' placeholder='Any Message' />
                                                    </div>
