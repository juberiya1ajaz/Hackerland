    ...
    <>
      <div className="text-white">
        ...
        <div className="flex flex-wrap flex-col-2 justify-around w-full px-16 pt-16 pb-24">
          <Link to="/chatroom">
            <div className="bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-60 bg-black border-r-8 border-b-8 rounded-xl w-[22rem] h-[22rem] cursor-pointer transition duration-500 transform hover:scale-105 border-4  border-black  ">
